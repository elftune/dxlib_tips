/*
	2019/01/28	タイピングソフトサンプル by elftune
...
struct TYPINGDATA
{
	...
	// 現在入力中の文字列
//	TCHAR TypingString[64]; // これは使わないな...
...
int WINAPI WinMain(_In_ HINSTANCE, _In_opt_ HINSTANCE, _In_ LPSTR, _In_ int)
{
	...
	TCHAR *pStrQTxt = TEXT("じそんなに結果重視ならじゃあ時間を測ろう"); // 全角文字のみにすること
	TCHAR *pStrKTxt = TEXT("じそんなにけっかじゅうしならじゃあじかんをはかろう");
